$(document).ready(function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            // let arrayCount = Object.keys(room["amenities"])
            // for(i = 0; i < arrayCount.length; i++){
            //     arrayTest.push(room["amenities"][Object.keys(room["amenities"])[i]]);
            // };
    ...
    $("#checkIn_date").datepicker({
        ...
        firstDay: 0,
        minDate: dateToday,
        // onSelect: function (dateText, inst) { $("#checkIn_date").val(dateText); $(this).datepicker("hide"); },
    ...
    $("#checkOut_date").datepicker({
        ...
        firstDay: 0,
        minDate: dateToday,
        // onSelect: function (dateText, inst) { $("#checkOut_date").val(dateText); $(this).datepicker("hide"); },
        // onClose: function (dateText, inst) {
        //   $("#checkOut_date").blur();
        // }
    });
...
function checkDate() {
    ...
    // var price = 1380;
    // $(".billPrice").html("$" + night * price);
    var price = (1380 * night || 0).toString(), result = ''; //顯示價錢並加上千位數符號
