$(document).ready(function () {
    ...
    $.ajax({
        url: "https://challenge.thef2e.com/api/thef2e2019/stage6/room/RA8NhExaXXZB7EODVALSDvFFQzj1JP0a4C1pwZ1acPaieRBwiWoCb0FE0KUbXaxg",
        type: 'GET',
        headers: {
...
function checkDate() {
    ...
    var price = (2460 * night || 0).toString(), result = ''; //顯示價錢並加上千位數符號
