$(document).ready(function () {
    ...
    $.ajax({
        url: "https://challenge.thef2e.com/api/thef2e2019/stage6/room/kICyWhZ5XsfI4n1d4gBOsDjIyIxNozwgmxYKyZpzi5pjLcU2Nl4RhiGrn6zaPuTJ",
        type: 'GET',
        headers: {
...
function checkDate() {
    ...
    var price = (2888 * night || 0).toString(), result = ''; //顯示價錢並加上千位數符號
