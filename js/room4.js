$(document).ready(function () {
    ...
    $.ajax({
        url: "https://challenge.thef2e.com/api/thef2e2019/stage6/room/g0mYhN6ignMz4VYW7eiWsXZN8DHolHzH8LuVmM6hq5h6BrrqrLMw4aJgHv7LZ3RQ",
        type: 'GET',
        headers: {
...
function checkDate() {
    ...
    var price = (1899 * night || 0).toString(), result = ''; //顯示價錢並加上千位數符號
